...
$('.product .fa-trash').on('click',function(){
  $(this).parentsUntil('.row').fadeOut(500);
})
    // ===== Fade buttons when check =====
    $('.checkValue').on("change", function () {
        let value = $('.message-grid .checkValue').prop("checked");
        let true_arr=0;
        let false_arr=0;

        $( ".message-grid" ).each(function(){
          let newvalue = $(this).find(".checkValue").prop("checked");
            if(newvalue == true)
            {
              true_arr++;
            }
    ...
    $("#check").click(function () {
        if ($("#check").prop("checked") == true) {
            $("#from1").prop("disabled", true);
            $("#to1").prop("disabled", true);
        }
        if ($("#check").prop("checked") == false) {
            $("#from1").prop("disabled", false);
    ...
    $("#check5").click(function () {
        ...
        if ($("#check5").prop("checked") == true) {
            $("#from5").prop("disabled", true);
            $("#to5").prop("disabled", true);
        }
        if ($("#check5").prop("checked") == false) {
            $("#from5").prop("disabled", false);
            $("#to5").prop("disabled", false);
        }
    ...
    $("#check6").click(function () {
        ...
        if ($("#check6").prop("checked") == true) {
            $("#from6").prop("disabled", true);
            $("#to6").prop("disabled", true);
        }
        if ($("#check6").prop("checked") == false) {
            $("#from6").prop("disabled", false);
            $("#to6").prop("disabled", false);
        }
    ...
    $("#check7").click(function () {
        ...
        if ($("#check7").prop("checked") == true) {
            $("#from7").prop("disabled", true);
            $("#to7").prop("disabled", true);
        }
        if ($("#check7").prop("checked") == false) {
            $("#from7").prop("disabled", false);
            $("#to7").prop("disabled", false);
        }
    ...
    $(".profile .profile-edit .input input,.profile .profile-section .input input,.profile .profile-section form textarea").blur(function () {
        $(this).parent().parent().find('.buttons').fadeIn();
    });
    ...
    $(" .pro-rate span").click(function () {
        if ($(this).attr('data-rate') == '1') {
            $(this).parent(".pro-rate").removeClass("star-1 star-2 star-3 star-4 star-5");
            $(this).parent(".pro-rate").addClass("star-1");
            document.getElementById("stars").value = "1";
            document.getElementById("tstars").value = "1";

        } else if ($(this).attr('data-rate') == '2') {
            $(this).parent(".pro-rate").removeClass("star-1 star-2 star-3 star-4 star-5");
            $(this).parent(".pro-rate").addClass("star-2");
            document.getElementById("stars").value = "2";
            document.getElementById("tstars").value = "2";

        } else if ($(this).attr('data-rate') == '3') {
            $(this).parent(".pro-rate").removeClass("star-1 star-2 star-3 star-4 star-5");
            $(this).parent(".pro-rate").addClass("star-3");
            document.getElementById("stars").value = "3";
            document.getElementById("tstars").value = "3";

        } else if ($(this).attr('data-rate') == '4') {
            $(this).parent(".pro-rate").removeClass("star-1 star-2 star-3 star-4 star-5");
            $(this).parent(".pro-rate").addClass("star-4");
            document.getElementById("stars").value = "4";
            document.getElementById("tstars").value = "4";

        } else {
            $(this).parent(".pro-rate").removeClass("star-1 star-2 star-3 star-4 star-5");
            $(this).parent(".pro-rate").addClass("star-5");
    ...
    $('.btn-add-phone').click(function () {
        ...
        $('.phone-list').append('' +
            ...
            '</ul>' +
            '</span>' +
            '<input type="text" name="phone[' + index + '][number]" class="form-control add_phone" style="margin-bottom:10px;height: 40px;border-top-left-radius: 4px;border-bottom-left-radius: 4px;" placeholder="+1 (999) 999 9999" />' +

            '<span class="input-group-btn">' +
            '<button class="btn btn-danger btn-remove-phone" type="button" style="height: 40px;margin-top: -10px;"><span class="glyphicon glyphicon-remove"></span></button>' +
            '</span>' +
            '</div>'
        );
    ...
    $(".login form .input .question_mark").hover(function () {

        $(".login form .input p").fadeToggle(500);
    });



    //    //Dog Animation in Send Message Page
    //    var dog_place = $(".scrollme div").offset().top;
    //    $(window).on('scroll', function () {
    //        var body_place = $(document).scrollTop();
    //
    //        if (body_place > dog_place) {
    //            $(".scrollme div").css({
    //                opacity: "0.0",
    //                left: "450px"
    //            });
    ...
    $("html,.list-wraps,.comments").niceScroll();
...
$('.pintop').click(function () {
    $(this).parent().parent().toggleClass('top');
})
