                ...
                <div class="col-md-3">
                    <div class="sidenav">
                        ...
                        <ul class="links list-unstyled">
                            ...
                            <a href="orders.php">
                                <li class="active"><i class="fas fa-clipboard-list icon"></i> <span>الطلبات المقدمة</span> <i class="fas fa-angle-left angle"></i></li>
                            </a>
                    ...
                    <div class="content">
                        <div class="table-responsive">
                            <table class="table table-bordered">
                                <thead>
                                    <tr>
                                        <th scope="col"><i class="fas fa-clipboard-check"></i> اسم الطلب</th>
                                        <th scope="col"><i class="fas fa-exclamation-circle"></i> حالة الطلب</th>
