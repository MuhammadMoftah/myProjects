        ...
        <div class="wrapper-page">
            <div class=" card-box">
                ...
                <div class="panel-body">
                     <form class="form-horizontal m-t-20" role="form" method="POST" action="{{ route('admin.password.request') }}">
                         {{ csrf_field() }}
                      ...
                      <div class="form-group m-b-0">
                            ...
                            <div class="form-group">
                                <input type="password" name="password" value="{{ old('password') }}" class="form-control" placeholder="@lang('lang.Password')" required="">
                            </div>
                            <div class="form-group">
                                <input type="password" name="password_confirmation" value="{{ old('password_confirmation') }}" class="form-control" placeholder="@lang('lang.Password confirmation')" required="">
                            </div>
