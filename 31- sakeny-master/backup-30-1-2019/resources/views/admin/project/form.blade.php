<div class="panel-body">
	...
	<div class="col-lg-12">
		...
		<div class="form-group {{ $errors->has('description_ar') ? ' has-error' : '' }} col-md-6">
		    ...
		    {!! Form::textarea('description_ar', null, ['class' => 'form-control', 'placeholder' =>  __('lang.description_ar'), 'rows' => 3, 'required']) !!}
		...
		<div class="form-group {{ $errors->has('description_en') ? ' has-error' : '' }} col-md-6">
		    ...
		    {!! Form::textarea('description_en', null, ['class' => 'form-control', 'placeholder' =>  __('lang.description_en'), 'rows' => 3, 'required']) !!}
		...
		<div class="form-group {{ $errors->has('developer_description_ar') ? ' has-error' : '' }} col-md-6">
		    ...
		    {!! Form::textarea('developer_description_ar', null, ['class' => 'form-control', 'placeholder' =>  __('lang.developer_description_ar'), 'rows' => 3, 'required']) !!}
		...
		<div class="form-group {{ $errors->has('developer_description_en') ? ' has-error' : '' }} col-md-6">
		    ...
		    {!! Form::textarea('developer_description_en', null, ['class' => 'form-control', 'placeholder' =>  __('lang.developer_description_en'), 'rows' => 3, 'required']) !!}
	            ...
	            <div class="row col-md-12">
	            	{{-- @if (request('name_en')) --}}
	                    ...
	                    <div class="col-md-2 single-image">
	                        <img src="{{ asset($image->image) }}" style=" height: 150px; width: 150px; box-shadow: 3px 1px 15px rgba(0, 0, 0, 0.3) !important;">
