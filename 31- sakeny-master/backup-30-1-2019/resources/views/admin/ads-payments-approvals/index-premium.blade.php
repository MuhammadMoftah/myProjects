...
@section('title','Ads Special Approvals'." - ".trans("lang.".end($breadcrumb)))
...
@section('content')
    ...
    @section('breadcrumb')
        @foreach ($breadcrumb as $bread)
            @if ($loop->remaining == 1)
                <li><a href="{{ url("$base_view/$route") }}">Ads Special Approvals</a></li>
            @elseif($loop->last)
                <li class="active">Ads Special Approvals</li>
            @else
