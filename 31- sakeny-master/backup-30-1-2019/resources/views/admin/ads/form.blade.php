<div class="panel-body">
	...
	<div class="form-group {{ $errors->has('level_of_finished_id') ? ' has-error' : '' }} col-md-6">
		...
		<div class="form-group {{ $errors->has('offer_type_id') ? ' has-error' : '' }} col-md-6">
		    ...
		    {!! Form::select('offer_type_id', $offer_type_list, null, ['class' => 'form-control select2']) !!}
		...
		<div class="form-group {{ $errors->has('bedrooms_num') ? ' has-error' : '' }} col-md-6">
		    ...
		    {!! Form::number('bedrooms_num', null, ['class' => 'form-control', 'placeholder' =>  __('lang.bedrooms_num'),'min'=>1]) !!}
	...
	{{-- 	<div class="form-group {{ $errors->has('finishing_level') ? ' has-error' : '' }} col-md-4">
		...
		<div class="form-group {{ $errors->has('description') ? ' has-error' : '' }} col-md-12">
		    ...
		    {!! Form::textarea('description', null, ['class' => 'form-control', 'placeholder' =>  __('lang.description'), 'rows' => 7]) !!}
		...
		@isset ($row)
		    <div class="col-md-12">
	            <label class="control-label col-md-2">@lang('lang.Current Images')</label><hr>
