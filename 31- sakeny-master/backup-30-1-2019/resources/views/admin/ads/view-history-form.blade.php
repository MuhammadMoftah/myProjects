<div class="panel-body">
    ...
    <div class="form-group {{ $errors->has('level_of_finished_id') ? ' has-error' : '' }} col-md-6">
        ...
        <div class="form-group {{ $errors->has('offer_type_id') ? ' has-error' : '' }} col-md-6">
            ...
            {!! Form::select('offer_type_id', $offer_type_list, null, ['class' => 'form-control ' ,'disabled']) !!}
        ...
        <div class="form-group {{ $errors->has('country_id') ? ' has-error' : '' }} col-md-6">
            ...
            {!! Form::select('country_id', $countries, null, ['class' => 'form-control  ','disabled', 'placeholder' =>  __('lang.select country')]) !!}
        ...
        <div class="form-group {{ $errors->has('description') ? ' has-error' : '' }} col-md-12">
            ...
            {!! Form::textarea('description', null, ['class' => 'form-control','disabled', 'placeholder' =>  __('lang.description'), 'rows' => 7]) !!}
        ...
        @isset ($row)
            <div class="col-md-12">
                <label class="control-label col-md-2">@lang('lang.images')</label><hr>
...
@push('script')
    ...
    <script>
        $(document).ready(function() {
            ...
            $.get('{{ url(ADMIN_PATH."/ads/api/users") }}',{user_type: $user_type}, function(data) {
                $('#userList').html(data);
            });
