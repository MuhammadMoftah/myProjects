...
<section class="latest-prop py-5">
    <div class="container mt-5">
        <div class="title">
            ...
            @if(app()->getLocale()=="ar")
            <h2 class="text-center">شقق معروضة للايجار في القاهرة و الاسكندرية و الجيزة</h2>
            <p>شوف وقارن بين اكثر من 1000 شقة معروضة للايجار في ارقي احياء مصر - اختار الشقة المناسبة لك من حيث السعر والمساحة والمنطقة وتواصل مع المعلن مباشرة الآن </p>
            @endif
        </div>
        @if(isset($cities))
