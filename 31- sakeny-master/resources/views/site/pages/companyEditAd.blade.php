            ...
            <div class="container">
                <div class="row">
                    <div class="col-xl-10 mx-auto">
                        ...
                        <form id="edit_form" action="{{route('company.ad.edit.post',$ad->id)}}" method="POST" enctype="multipart/form-data" class="form-row">
                            ...
                            {{-- <div class="form-group wow fadeInUp col-md-6" data-wow-duration="1s">
                                ...
                                <select class="form-control {{ $errors->has('agent') ? 'is-invalid' : ''}}" id="agent" name="agent">
                                    <option>{{trans('lang.agent')}}</option>
                                    @foreach($agents as $agent)
                                    <option {{$ad->agent_id==$agent->id?'selected':''}} value="{{$agent->id}}">{{$agent->name}}</option>
                                    @endforeach
                                </select>
                            ...
                            <input title="{{trans('lang.edit')}}" class="btn btn-primary form-control mt-3 wow fadeInUp" data-wow-duration="1s" type="submit" value="{{trans('lang.edit')}}">
                        </form>
