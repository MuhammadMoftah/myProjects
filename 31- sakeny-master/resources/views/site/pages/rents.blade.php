...
<section class="latest-prop py-5">
    <div class="container mt-5">
        <div class="title">
            ...
            @if(app()->getLocale()=='ar')
            <h2 class="text-center">عقارات معروضة للايجار في القاهرة و الاسكندرية و الجيزة وجميع محافظات مصر</h2>
            <p class="text-center">شوف واختار بين افضل العقارات المعروضة للايجار في مصر من شقق، فيلات، دوبلكس، تاون هاوس، ستوديو، شاليهات، عيادات ومحلات ومكاتب – سواء تجاري او سكني او إداري – وتواصل مع المعلن مباشرة الآن وبدون وسيط</p>
            @endif
        </div>
