            ...
            <div class="container">
                <div class="row">
                    <div class="col-xl-10 mx-auto">
                        ...
                        <form id="add_form" action="{{route('user.ad.create.post')}}" method="POST" enctype="multipart/form-data" class="form-row">
                            ...
                            <div class="form-group wow fadeInUp col-md-6" data-wow-duration="1s">
                                ...
                                <input value="{{old('title')}}" type="text" name="title" class="form-control {{ $errors->has('title') ? 'is-invalid' : ''}}" id="title" placeholder="{{trans('lang.title')}}">
                            ...
                            <div class="row w-100">
                                ...
                                <div class="form-group wow fadeInUp col-md-6" data-wow-duration="1s">
                                    ...
                                    <select class="form-control {{ $errors->has('type') ? 'is-invalid' : ''}}" id="type" name="type">
                                        @if(!old('type'))
                                        <option disabled selected>{{trans('lang.type')}}</option>
                                        @endif
                                        <option value="1">{{trans('lang.special_ads')}}</option>
                                        <option value="2">{{trans('lang.repeated_ads')}}</option>
                                        <option value="3">{{trans('lang.normal_ads')}}</option>
                                        <option value="4">{{trans('lang.seo_ads')}}</option>
                                    </select>
                            ...
                            <input class="btn btn-primary form-control mt-3 wow fadeInUp" data-wow-duration="1s" type="submit" value="{{trans('lang.add')}}">
                        </form>
...
<script src="{{url('site')}}/js/createAd.js"></script>
<script>
