...
@section('title',trans("lang.Ads_repeated")." - ".trans("lang.Index"))

@section('content')

<!-- Page-Title -->
@section('breadcrumb')
<li><a href="{{ url(ADMIN_PATH."/repeated") }}">@lang("lang.Ads_repeated")</a></li>
            ...
            <table class="table table-bordered">
                <thead>
                    <tr>
                        ...
                        <th> @lang('lang.package_expire_date') </th>
                    </tr>
                </thead>
                <tbody>
                    @include("$base_view.$path.loop_repeated")
                </tbody>
            </table>
