                                ...
                                <table class="row">
                                    <tr>
                                        <td class="wrapper last">
                                            ...
                                            <h4> Sakeny User Reset Password Link </h4>
                                            ...
                                            <a href="{{ route('user.newpassword.get', ['code' => $code, 'lang' => $lang]) }}"
                                               class="button button-blue" style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; 
                                               border-radius: 3px; box-shadow: 0 2px 3px rgba(0, 0, 0, 0.16); color: #FFF; display: inline-block; 
                                               text-decoration: none; -webkit-text-size-adjust: none; background-color: #3097D1; 
                                               border-top: 10px solid #3097D1; border-right: 18px solid #3097D1; border-bottom: 10px solid #3097D1; 
                                               border-left: 18px solid #3097D1;">Reset Password
                                            </a>
                                            ...
                                            <p style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #74787E; line-height: 1.5em; 
                                               margin-top: 0; text-align: left; font-size: 12px;">
                                                <a target="_blank" rel="noopener noreferrer" 
                                                   href="{{ route('user.newpassword.get', ['code' => $code, 'lang' => $lang]) }}" 
                                                   style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #3869D4;">
                                                    {{ route('user.newpassword.get', ['code' => $code, 'lang' => $lang]) }}
                                                </a>
                                            </p>
                                            <!-- END: Heading Content -->
                                        </td>
