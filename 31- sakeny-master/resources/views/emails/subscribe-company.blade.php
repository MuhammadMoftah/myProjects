                                    ...
                                    <tr>
                                        <td class="wrapper last">
                                            ...
                                            <table class="twelve columns">
                                                <tr>
                                                    <td>
                                                        <h4> Company Package Subscription Update</h4>
                                                        <hr>
                                                            <table border="1">
                                                                <tr>
                                                                    <td>Comapny Name</td>
                                                                ...
                                                                <tr>
                                                                    <td>Package</td>
                                                                    <td>{{ app()->getLocale() == 'en' ? $package->name_en : $package->name_ar }}</td>
                                                                </tr>
                                                                <tr>
                                                                    <td>Type</td>
                                                                    @if($package->type == 0)
                                                                ...
                                                                <tr>
                                                                    @if($flag == 0)
                                                                    <td colspan="2">Admin rejected your subscription</td>
                                                                    @elseif($flag == 1)
                                                                    <td colspan="2">Admin Accepted your subscription</td>
                                                                    @elseif($flag == 2)
                                                                    <td colspan="2">Admin Deacrivated your subscription</td>
                                                                    @endif
                                                                </tr>
                                                            </table>
                                                        </hr>
