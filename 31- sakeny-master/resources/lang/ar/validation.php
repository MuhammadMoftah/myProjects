...
return [
	...
	*/
	...
	'attributes' => [
		...
		'cr_number' => 'الرقم التجاري',
		'cr_number_file' => 'ملف الرقم التجاري',
		'registered_name' => 'الاسم المسجل',
		'terms_condition' => 'الاحكام و الشروط',
		'num_agents' => 'عدد الوكلاء',
		'reason' => 'السبب',
		'city_id' => 'المدينه',
		'offer_type_id' => 'نوع الاعلان',
		'property_type_id' => 'نوع العقار',
		'district_id' => 'الحي',
		'unit_view_id' => 'وجهه العقار',
		'size' => 'المساحه',
		'level_of_finished_id' => 'نوع التشطيب',
		'bedrooms_num' => 'عدد غرف النوم',
		'bathrooms_num' => 'عدد الحمامات',
		'building_year' => 'سنه البناء',
		'images' => 'الصور',
		'amenities' => 'وسائل الترفيه/الراحه',
		'able_email' => 'استقبال علي البريد الالكتروني',
		'able_chat' => 'استقبال رسائل',
		'able_call' => 'استقبال اتصال'
	],
