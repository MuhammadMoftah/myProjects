...
Route::group(['namespace'=>'Api'], function(){
	...
	Route::group(['prefix' => 'v1','namespace'=>'V1'], function() {
		...
		Route::group(['prefix'=>'user', 'namespace'=>'User'], function(){ // application name
			...
			Route::group(['prefix' => 'app'], function() {
				...
				Route::group(['middleware'=>'auth:api'], function(){
					...
					Route::get('ads-create-list','AdsController@createMobile');
		...
		Route::group(['prefix' => 'app'], function() {
			...
			Route::get('templates','ApplicationController@templates');
			Route::get('template/{id}','ApplicationController@template');
			...
			Route::get('life-style-list', 'ApplicationController@getLifeStyleList');
