...
define('CONSUMER_KEY', 'XYcg3eeWz4NhE8hVXEnkZgfIU');
define('CONSUMER_SECRET', '0meRlMVWiyZEkPdpaUXiD3zfKeL3oKyoKbjSpasdiZGLZbeLTZ');
define('OAUTH_CALLBACK', 'https://sakeny.com/twitter/index.php');
// start the session
session_start();
...
if(isset($login_url) && !isset($_SESSION['data'])){
	...
	echo "<script>window.location.href = 'Https://test.sakeny.com/en/auth/login?id=$data->id&email=$data->email&name=$data->name&image=$data->profile_image_url_https';</script>";
