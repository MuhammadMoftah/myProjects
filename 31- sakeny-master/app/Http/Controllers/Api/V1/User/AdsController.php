...
class AdsController extends CoreController
{
    ...
    public function create()
    {
        ...
        return $this->response(compact('proprty_type_list', 'sale_rent', 'amenities', 'unit_view_list', 'owner', 'agent', 'countries', 'cities', 'offer_type_list'));
    }
    ...
    public function createMobile()
    {
        $model = new Ads;
        $proprty_type_list = PropertyType::get(['name_en','name_ar', 'id']);
        $offer_type_list = OfferType::get(['title_en','title_ar', 'id']);
        $countries = Country::with('cities')->get(['name_en','name_ar', 'id']);
        $amenities = Amenities::where('activation', 1)->get(['name_en','name_ar', 'id']);
        $level_of_finished = LevelOfFinished::where('activation', 1)->get(['name_en','name_ar', 'id']);
        $unit_view_list = UnitView::get(['name_en','name_ar', 'id']);
        ...
        return $this->response(compact('proprty_type_list','level_of_finished', 'amenities', 'unit_view_list', 'owner', 'agent', 'countries', 'cities', 'offer_type_list'));
    }
