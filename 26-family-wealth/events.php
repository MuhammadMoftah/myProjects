...
<!-- Masthead -->
<header class="masthead cover" style="background: linear-gradient(to bottom, rgba(92, 77, 66, .8) 0, rgba(92, 77, 66, .8) 100%), url(./images/family4.jpg);background-position: 40% 30% !important">
...
<section class="page-section blog">
    <div class="container">
        <h2 class=" mt-0 text-center">Explore The Events</h2>
        <hr class="divider my-4" />
        <div class="row">
