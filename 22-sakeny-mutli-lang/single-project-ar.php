        ...
        <div class="inner">
            <div class="row">
                <div class="col-md-8 test">
                    ...
                    <div class="pt-5 wow fadeInUp text-right" data-wow-duration="1s" data-wow-delay="0.3s">
                        <h4 class="font-weight-bold">About Developer:</h4>
                        <img src="images/marasem.png" class="img-thumbnail" alt="" style="width:100px;">
                        <b class="font-weight-bold">Al-Marasem</b>
                ...
                <div class="col-md-4  wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.3s">
                    ...
                    <p class="font-weight-bold">0% down payment rest till 4 years 10 % discount 5% down payment then after 3 months 5% down payment rest till 6 years 10% down payment then after 3 months 10% then 10% on delivery rest till 8 years equal installm</p>
