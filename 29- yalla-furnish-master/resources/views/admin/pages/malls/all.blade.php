    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            <div class="header">
                ...
                <a href="{{route('admin.malls.create.get')}}" class="btn btn-primary waves-effect">
            ...
            @if(count($malls)>0)
            <div class="body table-responsive malls">
                @include('admin.pages.malls.malls_data')
            </div>
            @else
