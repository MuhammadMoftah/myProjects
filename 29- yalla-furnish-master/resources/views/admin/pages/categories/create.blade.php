    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            ...
            <div class="body">
                ...
                <form id="form_advanced_validation" method="POST" action="{{route('admin.category.create.post')}}" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    ...
                    <div class="form-group form-float">
                        <div class="form-line">
                            <input id="slug" type="text" value="{{old('slug')}}" class="form-control" name="slug" maxlenght="300" required>
                            <label class="form-label">* SLUG</label>
                        </div>
                        <div class="help-info">Max. Char: 300</div>
                    </div>
                    <div class="form-group form-float">
                        <div class="form-line">
                                * Category Image
