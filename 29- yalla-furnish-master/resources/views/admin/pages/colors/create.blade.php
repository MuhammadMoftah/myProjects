    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            ...
            <div class="body">
                ...
                <form id="form_advanced_validation" method="POST" action="{{route('admin.colors.create.post')}}">
                    {{ csrf_field() }}
                    ...
                    <div class="form-group form-float">
                        <div class="form-line">
                            <input id="code" type="text" value="{{old('code')}}" class="form-control" name="code" maxlenght="200" required>
