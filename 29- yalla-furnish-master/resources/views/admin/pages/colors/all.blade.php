    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            <div class="header">
                ...
                <a href="{{route('admin.colors.create.get')}}" class="btn btn-primary waves-effect">
            ...
            @if(count($colors)>0)
            <div class="body table-responsive colors">
                @include('admin.pages.colors.colors_data')
            </div>
            @else
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        function fetch_data(page) {
            var url = "{{route('admin.colors.get')}}";
