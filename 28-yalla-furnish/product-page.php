...
<section class="one-product showrooms">
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-8 p-0 fullheight">
            ...
            <div class="col-lg-4 px-4 fullheight" style="overflow-y:auto">
                <div class="company-info px-0">
                    <div class="d-inline-block">
                        <figure class="img" style="background-image: url(./images/comp-logo.png);"></figure>
                    </div>
                    <div class="d-inline-block">
                ...
                <div class="product-details p-2">
                    ...
                    <p class="font-weight-bold mt-4">Price: <span style="font-size:20px">8500 EGP</span></p>
