...
<body>
    <div style=" text-align: center;padding-top: 25px "><a class="back" href="{{ url('/')}}" > <img src="https://dev.jobadge.com/site/images/logo/logo.png" alt="Careers at Jobadge"></a> </div>
