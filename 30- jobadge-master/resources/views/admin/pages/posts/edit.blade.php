    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            ...
            <div class="body">
                ...
                <form id="form_advanced_validation" enctype="multipart/form-data" method="POST" action="{{route('admin.posts.edit.post',$post->id)}}">
                    {{ csrf_field() }}
                    <div class="form-group form-float">
                        <div class="form-line">
                            <textarea name="body" value="{{$post->body}}" cols="30" rows="5" class="form-control no-resize" required>{{$post->body}}</textarea>
                    ...
                    <div class="form-group form-float">
                        <div class="form-line">
                            ...
                            <select name="company_id" class="form-control show-tick" data-live-search="true" required>
                                ...
                                <option {{$company->id==$post->company_id?'selected':''}} value="{{$company->id}}">{{$company->name}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
