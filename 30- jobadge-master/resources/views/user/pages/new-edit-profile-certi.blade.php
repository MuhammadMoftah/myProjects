        ...
        <div class="row">
            <aside class="col-lg-3 bg-white rounded mb-3 pb-4 user-side-menu  d-none d-lg-block">
                ...
                <nav class="sections-links mt-4">
                    ...
                    <a class="active" href="{{url('new-edit-profile/certi')}}">Certificates</a>
                        ...
                        <div class="card-body py-0 d-flex justify-content-between align-items-center flex-column flex-sm-row">
                            <hgroup class="py-3">
                                <div>
                                    ...
                                    From
                                    <strong class="text-capitalize">Institute name </strong>
                                </div>
            ...
            <div class="modal-body">
                <form action="" method="POST" class="form-row" >
                    <div class="form-group col-md-6">
                        <label for="firstname">Certificate title</label>
                        <input type="text" name="" class="form-control " id="" placeholder="Certificate title">
                    </div>

                    <div class="form-group col-md-6">
                        <label for="lastname">Institute name</label>
                        <input value="" type="text" name="company_name" class="form-control " id="" placeholder="Institute name">
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="row">
                            ...
                            <div class="custom-control custom-checkbox mb-3 ml-4 col-md-12">
                                <input type="checkbox" name="subscription" class="custom-control-input currently-work" id="certi">
                                <label class="custom-control-label" for="certi">This certificate has no expirational date</label>
                            </div>
                ...
                <form action="" method="POST" class="form-row" >
                    ...
                    <div class="col-md-12">
                        <div class="row">
                            ...
                            <div class="custom-control custom-checkbox mb-3 ml-4 col-md-12">
                                <input type="checkbox" name="subscription" class="custom-control-input currently-work" id="certi2">
