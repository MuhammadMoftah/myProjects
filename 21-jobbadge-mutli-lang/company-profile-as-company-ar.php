        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4 part">
                    <div class="profile">
                        <div class="card">
                            <img src="images/logo/minvotech-logo.png" class="card-img-top" alt="...">
                            <div class="card-body">
                                <h5 class="card-title text-center">Minvotech</h5>
                ...
                <div class="col-md-8 part">
                    <nav>
                        <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
                            ...
                            <a class="nav-item nav-link w-25" id="nav-saved-tab" data-toggle="tab" href="#nav-saved" role="tab" aria-controls="nav-profile" aria-selected="false"><i class="far fa-save"></i> Saved</a>
                        </div>
                    </nav>
                    ...
                    <div class="tab-content py-3 px-3 px-sm-0" id="nav-tabContent">
                        <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                            <form action="" class="form-row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="name" class="form-control" id="exampleInputCompEmp" placeholder="4:20 " disabled>
                                </div>
                            </form>
                        </div>
                        ...
                        <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
                            <form action="" class="form-row">
                                ...
                                <div class="form-group col-md-6">
                                    <label for="exampleInputCompEmp">Employess number</label>
                                    <input type="name" class="form-control" id="exampleInputCompEmp" placeholder="4:20 ">
                                </div>

                                <div class="form-group col-md-6">
                                    <label for="CompType">Company Type</label>
                                    <input type="name" class="form-control" id="CompType" placeholder="Copmany Type">
                                </div>

                                <div class="form-group col-md-6">
                                    <label for="CompIndusty">Company industry</label>
                                    <input type="name" class="form-control" id="CompIndusty" placeholder="Company industry">
                                </div>
                                ...
                                <div class="form-group col-md-6">
                                    <label for="compLocation">Maps Location</label>
                                    <input type="name" class="form-control" id="compLocation" placeholder="Maps Location Link">
                                </div>

                                <div class="form-group col-md-12">
                                    <label for="compDescribtion">Describtion</label>
                                    <textarea class="form-control" id="compDescribtion" rows="5"></textarea>
                                </div>

                                <div class="form-group col-md-6">
                                    <label for="foundedDate">Founded date</label>
                                    <input type='text' id="foundedDate" placeholder="Founded date" class='form-control datepicker-here' data-language='en' />
                                </div>

                                <div class="form-group col-md-6"> Upload Company Documents
                                    <input type="file" class="custom-file-input" id="compFiles">
                                    <label style="width: 90%;top:32px" class="custom-file-label text-danger" for="compFiles">Documents in One PDF</label>
                                </div>

                                <div class="form-group col-md-6"> Partners Logo
                                    <input type="file" class="custom-file-input" id="partnersLogo">
                                    <label style="width: 90%;top:32px" class="custom-file-label" for="partnersLogo">Partners Logo</label>
                                </div>

                                <div class="form-group col-md-6"> Company Logo
                                    <input type="file" class="custom-file-input" id="compLogo">
                                    <label style="width: 90%;top:32px" class="custom-file-label" for="compLogo">Company Logo</label>
                                </div>

                                <div class="form-group col-md-6"> Company Video
                                    <input type="file" class="custom-file-input" id="compVideo">
                                    <label style="width: 90%;top:32px" class="custom-file-label" for="compVideo">Company Video</label>
                                </div>

                                <div class="form-group col-md-6"> Company URL of Profile
                                    <input type="file" class="custom-file-input" id="compURL">
                                    <label style="width: 90%;top:32px" class="custom-file-label" for="compURL">Company URL</label>
                                </div>
                        ...
                        <div class="tab-pane fade" id="nav-account" role="tabpanel" aria-labelledby="nav-profile-tab">
                            <form action="" class="form-row">
                                ...
                                <div class="form-group  pt-3 border-top text-center col-md-12">
                                    <div class="btn btn-danger" id="compDelete"> Delete My Company </div>
                                </div>
                            </form>
                        </div>
