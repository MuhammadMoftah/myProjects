...
<div class="container-blog-posts">
    <div class="blog-posts-header">
        <div class="container">
            <h2 class="section-title"><span>RECENT JOBS</span></h2>
        </div>
    </div>
    ...
    <div class="container">
        <div class="post-jobs-filter">
            <div class="row no-gutters align-items-center">
                    ...
                    <div class="row no-gutters">
                        <div class="col-12 col-md-4">
                            <div class="post-jobs-filter-select first">
                                <div class="select-title">Exper. Years</div>
                        ...
                        <div class="col-12 col-md-4">
                            <div class="post-jobs-filter-select">
                                <div class="select-title">Salary Range</div>
                                <div class="select-value">
                                    <select name="" class="select-field">
                                        <option value="1">0:3000
                                        <option value="2">3000:7000
                                        <option value="3">7000:10000
                                    </select>
                                </div>
                                <span class="icon icon-down"></span>
                            </div>
                ...
                <div class="col-4 col-md-2 col-xl-2 text-right">
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6 col-xl-4">
                    <div class="grid-view-item">
                        ...
                        <a href="job-details.php" title="" class="button-outline"><span>DETAILS</span></a>
                        <div class="row no-gutters">
                ...
                <div class="col-12 col-md-6 col-xl-4">
                    <div class="grid-view-item">
                        ...
                        <h5 class=" item-company-name">Envato Element Ltd</h5>
                        <a href="job-details.php" title="" class=" button-outline"><span>APPLY</span></a>
                        <div class="row no-gutters">
                            <div class="col-12 col-md-7 text-left">
                                <span class="icon icon-pin"></span>
        ...
        <div class="row">
            <div class="col-12 col-md-6 offset-md-3 col-xl-4 offset-xl-4 text-center">
                <a href="#" class="button-fill post-job-more">VIEW ALL OPEN JOBS</a>
            </div>
        </div>
